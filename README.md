...
All the cell line and tissue pre-trained models along with the scripts can be downloaded from https://zenodo.org/ using the accession number _**22705426**_ (https://doi.org/10.5281/zenodo.22705426).
